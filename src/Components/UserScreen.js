...
const UserScreen = ({ navigation }) => {
  ...
  //       />
  //     ),
  //     headerTitle: () => <HeaderTitle title={"UserScreen"} />,
  //     headerLeft: () => (
  //       <HeaderLeft
  //         text={""}
  //         iconName={backIcon}
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <CustomText
          text={"UserScreen OF LIABILITY AND WARNING"}
          style={[{ alignSelf: "center", fontStyle: 'italic' }, TextStyles.textQuicksandBold14Black, SpaceStyles.bottom5]}
        />

        <CustomText
          text={"By visiting, viewing, browsing, surfing or using our website www.soundandsoulful.com (“Website”) or availing any of the Website Services (as defined in the Terms and Conditions), you (“you”, “your” or “User”) agree to this UserScreen of Liability."}
